...
sys_env_destroy(envid_t envid)
{
  ...
  800118:	00 
  800119:	c7 44 24 08 8a 0e 80 	movl   $0x800e8a,0x8(%esp)
  800120:	00 
  800121:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800128:	00 
  800129:	c7 04 24 a7 0e 80 00 	movl   $0x800ea7,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800188:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
  ...
  80019e:	e8 51 00 00 00       	call   8001f4 <vcprintf>
	cprintf("\n");
  8001a3:	c7 04 24 dc 0e 80 00 	movl   $0x800edc,(%esp)
