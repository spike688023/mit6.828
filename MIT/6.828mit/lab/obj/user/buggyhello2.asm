...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	00 
  80011a:	c7 44 24 08 98 0e 80 	movl   $0x800e98,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 b5 0e 80 00 	movl   $0x800eb5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800189:	c7 04 24 c4 0e 80 00 	movl   $0x800ec4,(%esp)
  ...
  80019f:	e8 51 00 00 00       	call   8001f5 <vcprintf>
	cprintf("\n");
  8001a4:	c7 04 24 8c 0e 80 00 	movl   $0x800e8c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 e8 0e 80 00 	movsbl 0x800ee8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800509:	c7 44 24 08 00 0f 80 	movl   $0x800f00,0x8(%esp)
  800510:	00 
  ...
  800529:	c7 44 24 08 09 0f 80 	movl   $0x800f09,0x8(%esp)
  800530:	00 
  ...
  80055b:	b8 f9 0e 80 00       	mov    $0x800ef9,%eax
