...
exit(void)
{
  ...
  800156:	e8 b8 0a 00 00       	call   800c13 <sys_env_destroy>
}
  80015b:	c9                   	leave  
  80015c:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80016e:	e8 f2 0a 00 00       	call   800c65 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001e0:	e8 f1 09 00 00       	call   800bd6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800249:	e8 88 09 00 00       	call   800bd6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002df:	e8 ac 09 00 00       	call   800c90 <__udivdi3>
  ...
  80033f:	e8 7c 0a 00 00       	call   800dc0 <__umoddi3>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80046a:	ff 24 95 a0 10 80 00 	jmp    *0x8010a0(,%edx,4)
  ...
  800529:	c7 44 24 08 2d 10 80 	movl   $0x80102d,0x8(%esp)
  800530:	00 
  ...
  80055b:	b8 1d 10 80 00       	mov    $0x80101d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c58:	e8 00 f5 ff ff       	call   80015d <_panic>
