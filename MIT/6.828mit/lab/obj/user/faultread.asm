	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 a8 0e 80 00 	movsbl 0x800ea8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800409:	c7 44 24 08 c0 0e 80 	movl   $0x800ec0,0x8(%esp)
  800410:	00 
  ...
  800429:	c7 44 24 08 c9 0e 80 	movl   $0x800ec9,0x8(%esp)
  800430:	00 
  ...
  80045b:	b8 b9 0e 80 00       	mov    $0x800eb9,%eax
