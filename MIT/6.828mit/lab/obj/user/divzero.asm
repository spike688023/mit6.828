...
exit(void)
{
  ...
  8000ba:	e8 64 0a 00 00       	call   800b23 <sys_env_destroy>
}
  8000bf:	c9                   	leave  
  8000c0:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000ee:	e8 f3 09 00 00       	call   800ae6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800157:	e8 8a 09 00 00       	call   800ae6 <sys_cputs>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800419:	c7 44 24 08 b0 0e 80 	movl   $0x800eb0,0x8(%esp)
  800420:	00 
  ...
  800439:	c7 44 24 08 b9 0e 80 	movl   $0x800eb9,0x8(%esp)
  800440:	00 
  ...
  80046b:	b8 a9 0e 80 00       	mov    $0x800ea9,%eax
